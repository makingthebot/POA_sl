...
from typing import Literal, Union, Callable, TypeVar
import pendulum
import time
...
from .model import CRYPTO_EXCHANGES, STOCK_EXCHANGES, MarketOrder, LimitOrder, ChangeSLOrder
...
#OrderType = TypeVar('OrderType', MarketOrder, LimitOrder)
