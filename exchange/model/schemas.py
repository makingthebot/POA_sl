...
class OrderRequest(BaseModel):
    ...
    use_tp4: bool | None = None
    tp1_qty_percent: float | None = None
    tp2_qty_percent: float | None = None
    tp3_qty_percent: float | None = None
    tp4_qty_percent: float | None = None
